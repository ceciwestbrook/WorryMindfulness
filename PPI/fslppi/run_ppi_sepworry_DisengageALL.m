...
function p = run_ppi_DisengageALL(subject,run_num)
...
% The path to the feat directory
 featdir=['/mnt/Worry_and_Mindfulness/Subjects/',num2str(subject),'/func/WM/model/level1/',...
     'run',num2str(run_num),'_DisengageALL_sepworry.feat'];
...
[A1 B1]=fsl_ppi(featdir, voi, [0 0 0 0 0 1 0 0], 0);
[A2 B2]=fsl_ppi(featdir, voi, [0 0 0 0 1 0 0 0], 0);
...
save(['/mnt/Worry_and_Mindfulness/Subjects/',num2str(subject),'/func/WM/model/PPI/',...
    'DisengageALL_wnyesno_pos_ppi_run',num2str(run_num),'.txt'], 'ppi_01', '-ascii')
save(['/mnt/Worry_and_Mindfulness/Subjects/',num2str(subject),'/func/WM/model/PPI/',...
    'DisengageALL_wnyesno_neg_ppi_run',num2str(run_num),'.txt'], 'ppi_02', '-ascii')
