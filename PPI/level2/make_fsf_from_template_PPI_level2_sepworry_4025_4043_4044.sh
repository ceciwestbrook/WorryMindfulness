...
for dirname in /mnt/Worry_and_Mindfulness/Subjects/4025 /mnt/Worry_and_Mindfulness/Subjects/4043 /mnt/Worry_and_Mindfulness/Subjects/4044
do
   ...
   for copename in AcceptFA_fullreg AcceptSuppress_fullreg FASuppress_fullreg ; do
	...
	do
	  ...
	  echo $subnum' '$run' '$featname' '$altrun
		...
		sed -i "s/DIRNAME/sepworry_ONLYworry/g" "${subnum}_level2_ppi_${copename}_partial.fsf"
